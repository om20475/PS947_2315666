...
We have plotted a set of prior predictions for our Beta distribution. For the alpha parameter we have created a set of values using normal distribution of a range between 65 and 85 as we are assuming top range of marks varies between the mentioned range. And similarly, for Beta we generated the set of normally distributed values within the range between 40 and 50 (assumed as minimum obtained marks.)
